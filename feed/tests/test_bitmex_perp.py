...
from cryptofeed.exchanges import Binance, BinanceFutures #Bitmex
...
from custom_bitmex import Bitmex
...
def main():
    ...
    try:
        ...
        # fh.add_feed(Bitmex(timeout=5000, symbols=symbols_fut, 
        ...
        #                 )
        #                 )
        fh.add_feed(Bitmex(timeout=5000,
                           max_depth=50,
                        subscription={
                            L2_BOOK: symbols_fut, #l3_book is not supported on BITMEX
                            TRADES: symbols_fut,
                            FUNDING: symbols_fut,
                        ...
                        callbacks={
                            L2_BOOK:[book], #l3_book is not supported on BITMEX
                            TRADES:[trade],
                            FUNDING:[funding],
                            OPEN_INTEREST:[oi],
