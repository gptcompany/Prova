...
from custom_bybit import Bybit
...
def main():
    ...
    try:
        ...
        symbols_fut = ['BTC-USD-PERP','BTC-USDT-PERP','BTC-USD', 'BTC-USDT']
        ...
        #                 )
        #                 )
        # fh.add_feed(Bybit(timeout=5000,
        #                    max_depth=50,
        #                 subscription={
        #                     L2_BOOK: symbols_fut, #l3_book is not supported on BYBIT
        #                     TRADES: symbols_fut,
        #                     FUNDING: symbols_fut,
        ...
        #                 },
        #                 callbacks={
        #                     L2_BOOK:[book], #l3_book is not supported on BYBIT
        #                     TRADES:[trade],
        #                     FUNDING:[funding],
        #                     OPEN_INTEREST:[oi],
