...
def main():
    ...
    try:
        ...
        pairs = Kraken.symbols()[:]
        print(pairs)
        
        symbols_fut = ['BTC-USD','ETH-USDT']
        ...
        #                 )
        #                 )
        fh.add_feed(Kraken(timeout=5000,
                           max_depth=50,
                           checksum_validation=True,
                        subscription={
                            L2_BOOK: symbols_fut, #l3_book is not supported on Kraken
                            TRADES: symbols_fut,
                            #FUNDING: symbols_fut,  
                        ...
                        callbacks={
                            L2_BOOK:[book], #l3_book is not supported on Kraken
                            TRADES:[trade],
                            #FUNDING:[funding],
                            # OPEN_INTEREST:[oi],
