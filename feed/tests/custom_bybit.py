...
class Bybit(Feed):
    ...
    websocket_endpoints = [
        WebsocketEndpoint('wss://stream.bybit.com/v5/public/linear', channel_filter=(websocket_channels[L2_BOOK], websocket_channels[TRADES], websocket_channels[INDEX], websocket_channels[OPEN_INTEREST], websocket_channels[FUNDING], websocket_channels[CANDLES], websocket_channels[LIQUIDATIONS]), instrument_filter=('QUOTE', ('USDT', 'USDC')), sandbox='wss://stream-testnet.bybit.com/v5/public/linear', options={'compression': None}),
        WebsocketEndpoint('wss://stream.bybit.com/v5/public/inverse', channel_filter=(websocket_channels[L2_BOOK], websocket_channels[TRADES], websocket_channels[INDEX], websocket_channels[OPEN_INTEREST], websocket_channels[FUNDING], websocket_channels[CANDLES], websocket_channels[LIQUIDATIONS]), instrument_filter=('QUOTE', ('USD',)), sandbox='wss://stream-testnet.bybit.com/v5/public/inverse', options={'compression': None}),
        WebsocketEndpoint('wss://stream.bybit.com/v5/private', channel_filter=(websocket_channels[ORDER_INFO], websocket_channels[FILLS]), sandbox='wss://stream-testnet.bybit.com/v5/private', options={'compression': None}),
    ]
